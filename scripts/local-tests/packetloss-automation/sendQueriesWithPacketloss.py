...
dns_request_dest_ip = "192.168.1.33"  # IP Address of the DNS Resolver
dns_request_src_port = RandShort()    # Source port is random
dns_request_dest_port = 53            # Destination port is 53
dns_request_rd = 1                    # Recursion desired
dns_request_qr = 0                    # message is a query (0), or a response (1)
dns_request_qname = "nameserver1.intranet.lol"  # Domain name to query

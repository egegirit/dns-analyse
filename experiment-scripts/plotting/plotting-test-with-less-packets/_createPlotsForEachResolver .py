...
def create_box_plot_for_resolver(directory_name, file_name, operator_specific_packet_list, bottom_limit, upper_limit, log_scale=False):
    ...
    for rcode_filter in all_possible_rcodes:
        ...
        for file_name in file_names:
            ...
            for operator in list_of_operators:
                ...
                create_box_plot_for_resolver(directory_names[directory_index], file_name, operator, bottom_limit, upper_limit, log_scale_y_axis)

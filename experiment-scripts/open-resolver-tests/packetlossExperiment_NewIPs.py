...
def build_and_send_query_mp(args_list):
    ...
    for c in range(counter_min, counter_max):
        ...
        try:
            ...
            print(f"      Exception or timeout occured for {query_prefix} ")
            answers = None
...
for current_packetloss_rate in packetloss_rates:
    ...
    capture_processes = start_packet_captures(directory_name_of_logs, current_packetloss_rate, interface_1, interface_2,
                                              interface_3)

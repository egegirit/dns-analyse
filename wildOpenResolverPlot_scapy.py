...
def is_query_name_valid(query_name):
    if ".public-pl" not in query_name or "packetloss.syssec-research.mmci.uni-saarland.de" not in query_name or "_" not in query_name:
...
def create_plots_of_type(file_name, pcap_file_prefix, directory_type):
    ...
    for current_pl_rate in packetloss_rates:
        ...
        read_pcap(pcap_file_name, current_pl_rate)
...
def create_plots(file_name):
    ...
    # Create client plots
    create_plots_of_type(file_name, client_prefix, client_plots_directory_name)
    ...
    # Create auth plots
    create_plots_of_type(file_name, auth_prefix, auth_plots_directory_name)
...
create_plots("Wild-Open-Resolvers")

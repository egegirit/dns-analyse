...
# Create stacked bar chart (rates of: non_stale, stale, refused and servfail packets)
def create_bar_plot_for_retransmission_succes_rate(file_name_prefix, directory_name, data_dict, root_directory_name, plot_title, y_label):
...
def create_plots_for(file_name):
    ...
    create_bar_plot_for_retransmission_succes_rate(file_name, retransmission_plots_directory_name, success_ratios,
                    auth_root_plot_folder_name, "Retransmission Success Rates", "Retransmission Success Rates")
